<template>
  <div
    ...
    v-bind="$attrs"
    class="grow cursor-pointer border-transparent bg-surface-white rounded-md shadow dark:border dark:border-outline-gray-2 text-base leading-6 transition-all duration-300 ease-in-out"
  >
    <div
